  ...
  public void paint(Graphics paramGraphics)
  {
    ...
    if ((this.keySignature > 0) && (this.keySignature < 8)) {
      for (k = 0; k < this.keySignature; k++)
      {
        ...
        this.g.drawImage(this.sharp, this.rightMargin + this.clefWidth + j, n + this.staveSpaceHeight, this);
        j += 10;
        i1 = this.sharps[k] % 12;
        for (i2 = 0; i2 < 128; i2++) {
          if (i2 % 12 == i1)
      ...
      for (k = 0; k < Math.abs(this.keySignature); k++)
      {
        ...
        this.g.drawImage(this.flat, this.rightMargin + this.clefWidth + j, n + this.staveSpaceHeight, this);
        j += 10;
        i1 = this.flats[k] % 12;
        for (i2 = 0; i2 < 128; i2++) {
          if (i2 % 12 == i1)
    ...
    for (int m = 0; m < this.phrase.size(); m++)
    {
      ...
      chooseImage(n, this.phrase.getNote(m).getRhythmValue(), 50, 0, 50);
      if ((n == Integer.MIN_VALUE) || (this.phrase.getNote(m).getRhythmValue() == 0.0D)) {
        i1 = this.notePosOffset[11] + this.bPos - 4 + 0 + 4;
      } else {
        i1 = this.notePosOffset[(n % 12)] + this.bPos - 4 + (5 - n / 12) * 24 + ((6 - n / 12) * 4 - this.staveSpaceHeight * 6);
      }
      int i3;
      ...
      this.notePositions.addElement(new Integer(i1 + this.staveDelta));
      if (this.dottedNote)
      {
        i2 = 1;
...
/* Location:              C:\Users\Kweku Emuze\Downloads\jMusic1.6.4.jar!\jm\gui\cpn\BassStave.class
