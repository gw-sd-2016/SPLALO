  ...
  implements JMC
{
  ...
  public void paint(Graphics paramGraphics)
  {
    ...
    int i = 0;
    if (getDisplayTitle()) {
      this.g.drawString(this.title, this.rightMargin, 60);
    }
    int j = 0;
    int k;
    int n;
    ...
    for (int m = 0; m < this.phrase.size(); m++)
    {
      ...
      if ((this.metre != 0.0D) && (d % this.metre == 0.0D))
      {
        ...
        if (this.barNumbers) {
          this.g.drawString("" + (int)(d / this.metre + 1.0D + this.phrase.getStartTime()), this.totalBeatWidth - 4, this.bPos - 50);
        }
...
/* Location:              C:\Users\Kweku Emuze\Downloads\jMusic1.6.4.jar!\jm\gui\cpn\GrandStave.class
